...
import com.xlxyvergil.tcc.items.curios.AlloyDrill;
import com.xlxyvergil.tcc.items.curios.BlazeStorm;
import com.xlxyvergil.tcc.items.curios.BlazeStormPrime; 
import com.xlxyvergil.tcc.items.curios.BulletSpread;
import com.xlxyvergil.tcc.items.curios.CarefulHeart;
import com.xlxyvergil.tcc.items.curios.Chamber;
import com.xlxyvergil.tcc.items.curios.ChamberPrime;
...
import com.xlxyvergil.tcc.items.curios.EvilAccuracy;
import com.xlxyvergil.tcc.items.curios.FerociousExtension;
import com.xlxyvergil.tcc.items.curios.HeavenFireApocalypse;
import com.xlxyvergil.tcc.items.curios.HeavenFireJudgment;
import com.xlxyvergil.tcc.items.curios.HeavyCaliberTag;
import com.xlxyvergil.tcc.items.curios.HeavyFirepower;
import com.xlxyvergil.tcc.items.curios.InfectedMagazine;
import com.xlxyvergil.tcc.items.curios.InfernalChamber;
import com.xlxyvergil.tcc.items.curios.KikakuIchijin;
import com.xlxyvergil.tcc.items.curios.LimitSpeed;
import com.xlxyvergil.tcc.items.curios.BurstReload;
import com.xlxyvergil.tcc.items.curios.MalignantSpread;
import com.xlxyvergil.tcc.items.curios.MergedRifling;
import com.xlxyvergil.tcc.items.curios.OverloadedMagazine;
import com.xlxyvergil.tcc.items.curios.ProphecyPact;
import com.xlxyvergil.tcc.items.curios.RedMovementTag;
import com.xlxyvergil.tcc.items.curios.Rifling;
import com.xlxyvergil.tcc.items.materials.RiftSilver;
import com.xlxyvergil.tcc.items.curios.RippingPrime;
import com.xlxyvergil.tcc.items.curios.SoldierBasicTag;
import com.xlxyvergil.tcc.items.curios.SoldierSpecificTag;
import com.xlxyvergil.tcc.items.curios.SplitChamber;
import com.xlxyvergil.tcc.items.curios.OppressionPoint;
import com.xlxyvergil.tcc.items.curios.OppressionPointPrime;
import com.xlxyvergil.tcc.items.curios.SustainedFire;
import com.xlxyvergil.tcc.items.curios.SwordWind;
import com.xlxyvergil.tcc.items.curios.SwordWindPrime;
import com.xlxyvergil.tcc.items.curios.TacticalReload;
import com.xlxyvergil.tcc.items.curios.UralWolfTag;
import com.xlxyvergil.tcc.items.curios.WaspStinger;
import com.xlxyvergil.tcc.items.curios.DepletedReload;
import com.xlxyvergil.tcc.items.curios.BurstReloadPrime;
...
import com.xlxyvergil.tcc.items.curios.CriticalDelay;
import com.xlxyvergil.tcc.items.curios.LethalCrit;
import com.xlxyvergil.tcc.items.curios.WeaknessSense;
import com.xlxyvergil.tcc.items.curios.Destruction;
import com.xlxyvergil.tcc.items.curios.DestructionPrime;
import com.xlxyvergil.tcc.items.curios.ThunderBarrel;
import com.xlxyvergil.tcc.items.curios.ThunderBarrelPrime;
import com.xlxyvergil.tcc.items.curios.WeaknessMastery;
import com.xlxyvergil.tcc.items.curios.WeaknessMasteryPrime;
import com.xlxyvergil.tcc.items.curios.HollowPoint;
import com.xlxyvergil.tcc.items.curios.PistolMastery;
import com.xlxyvergil.tcc.items.curios.PistolMasteryPrime;
import com.xlxyvergil.tcc.items.curios.SteelSlash;
import com.xlxyvergil.tcc.items.curios.Dismemberment;
import com.xlxyvergil.tcc.items.curios.SacrificeOppression;
import com.xlxyvergil.tcc.items.curios.SacrificeSteel;
import com.xlxyvergil.tcc.items.curios.ArgonScope;
import com.xlxyvergil.tcc.items.curios.GildedArgonScope;
import com.xlxyvergil.tcc.items.curios.SharpBullet;
import com.xlxyvergil.tcc.items.curios.GildedSplitChamber;
import com.xlxyvergil.tcc.items.curios.LaserScope;
import com.xlxyvergil.tcc.items.curios.FragmentShot;
import com.xlxyvergil.tcc.items.curios.GildedInfernalChamber;
import com.xlxyvergil.tcc.items.curios.HydraulicCrosshair;
import com.xlxyvergil.tcc.items.curios.GildedHydraulicCrosshair;
import com.xlxyvergil.tcc.items.curios.SharpAmmo;
import com.xlxyvergil.tcc.items.curios.GildedBulletSpread;
import com.xlxyvergil.tcc.items.curios.GildedSteelSlash;
