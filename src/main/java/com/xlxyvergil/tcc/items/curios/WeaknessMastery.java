...
public class WeaknessMastery extends BaseCurioItem {
    ...
    private static final UUID CRIT_DAMAGE_UUID = UUID.fromString("a1b2c3d4-4001-4000-8000-000000000001");
    ...
    protected void applyEffects(LivingEntity livingEntity) {
        if (GunTypeChecker.isHoldingPistol(livingEntity)) {
            double critDamageBoost = FusionUpgradeUtil.getActualValue(TaczCuriosConfig.COMMON.weaknessMasteryCritDamage.get(), getFusionLevel());
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        double critDamageBoost = FusionUpgradeUtil.getActualValue(TaczCuriosConfig.COMMON.weaknessMasteryCritDamage.get() * 100, FusionUpgradeUtil.getLevel(stack));
