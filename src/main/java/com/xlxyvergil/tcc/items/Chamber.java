...
public class Chamber extends ItemBaseCurio {
    ...
    public void onEquip(SlotContext slotContext, ItemStack prevStack, ItemStack stack) {
        ...
        applyChamberEffect(livingEntity);
    ...
    public void onUnequip(SlotContext slotContext, ItemStack newStack, ItemStack stack) {
        ...
        // 移除生物的属性修改
        LivingEntity livingEntity = (LivingEntity) slotContext.entity();
        removeChamberEffect(livingEntity);
     ...
     * 提升狙击枪伤害（乘算）
     */
    public void applyChamberEffect(LivingEntity livingEntity) {
        // 检查生物主手是否持有狙击枪且弹匣满弹药
     ...
     * 移除膛室效果
     */
    public void removeChamberEffect(LivingEntity livingEntity) {
        var attributes = livingEntity.getAttributes();
    ...
    public void curioTick(SlotContext slotContext, ItemStack stack) {
        // 确保效果持续生效
        applyChamberEffect((LivingEntity) slotContext.entity());
    }
