...
public class ArgonScope extends BaseCurioItem {
    ...
    private static final UUID BASE_CRIT_UUID = UUID.fromString("b1c2d3e4-7001-4000-8000-000000000001");
    private static final String BASE_CRIT_NAME = "tcc.argon_scope.base_crit";
    ...
    protected void applyEffects(LivingEntity livingEntity) {
        if (GunTypeChecker.isHoldingDmgBoostGunType(livingEntity)) {
            double baseCrit = TaczCuriosConfig.COMMON.argonScopeBaseCritChance.get();
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        double buffCrit = TaczCuriosConfig.COMMON.argonScopeCritChancePerLevel.get() * 100;
