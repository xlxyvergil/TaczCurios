...
public class ChamberPrime extends ItemBaseCurio {
    ...
    // 效果参数
    private static final double DAMAGE_BOOST = 1.00;       // 100%伤害提升（乘算）
     ...
     * 提升狙击枪伤害（乘算）
     */
    private void applyChamberPrimeEffect(Player player) {
     ...
     * 移除膛室Prime效果
     */
    private void removeChamberPrimeEffect(Player player) {
        var attributes = player.getAttributes();
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        // 添加物品描述
        tooltip.add(Component.translatable("item.tcc.chamber_prime.desc")
        ...
        // 添加装备效果
        tooltip.add(Component.translatable("item.tcc.chamber_prime.effect")
