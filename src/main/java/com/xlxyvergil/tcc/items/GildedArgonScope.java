...
/**
 * 镀层氩晶瞄具 - 步枪饰品（爆头/爆头击杀触发Buff）
 * 基础：暴击几率+120%，爆头→Buff A / 爆头击杀→Buff B，可叠加5层（12s）
 */
public class GildedArgonScope extends BaseCurioItem {

    private static final UUID BASE_CRIT_UUID = UUID.fromString("b1c2d3e4-7002-4000-8000-000000000001");
    private static final String BASE_CRIT_NAME = "tcc.gilded_argon_scope.base_crit";
    ...
    protected void applyEffects(LivingEntity livingEntity) {
        if (GunTypeChecker.isHoldingDmgBoostGunType(livingEntity)) {
            double baseCrit = TaczCuriosConfig.COMMON.gildedArgonScopeBaseCritChance.get();
