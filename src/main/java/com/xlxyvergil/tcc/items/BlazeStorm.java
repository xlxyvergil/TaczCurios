...
public class BlazeStorm extends ItemBaseCurio {
    ...
    private static final UUID EXPLOSION_RADIUS_UUID = UUID.fromString("11111111-1234-1234-1234-123456789abc");
    private static final UUID EXPLOSION_DAMAGE_UUID = UUID.fromString("11111111-1234-1234-1234-123456789abd");
    ...
    /**
     * 应用所有效果加成
     * 增加24%爆炸范围（乘算），增加24%爆炸伤害（乘算）
     */
    private void applyEffects(Player player) {
        // 应用爆炸范围加成 (24%乘算)
        applyAttributeModifier(player, "taa", "explosion_radius", 0.24, EXPLOSION_RADIUS_UUID, EXPLOSION_RADIUS_NAME);
        
        // 应用爆炸伤害加成 (24%乘算)
        applyAttributeModifier(player, "taa", "explosion_damage", 0.24, EXPLOSION_DAMAGE_UUID, EXPLOSION_DAMAGE_NAME);
    }
