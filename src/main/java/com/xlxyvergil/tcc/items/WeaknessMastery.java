...
public class WeaknessMastery extends BaseCurioItem {
    ...
    protected void applyEffects(LivingEntity livingEntity) {
        if (GunTypeChecker.isHoldingPistol(livingEntity)) {
            double critDamageBoost = TaczCuriosConfig.COMMON.weaknessMasteryCritDamage.get();
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        double critDamageBoost = TaczCuriosConfig.COMMON.weaknessMasteryCritDamage.get() * 100;
