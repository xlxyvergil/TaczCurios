...
public class TccDamageSources {
    ...
    public static final ResourceKey<DamageType> IMAGINARY_DAMAGE =
        ResourceKey.create(Registries.DAMAGE_TYPE, ResourceLocation.fromNamespaceAndPath("tcc", "imaginary_damage"));

    public static final TagKey<DamageType> IMAGINARY_DAMAGE_TAG =
        TagKey.create(Registries.DAMAGE_TYPE, ResourceLocation.fromNamespaceAndPath("tcc", "imaginary_damage"));
