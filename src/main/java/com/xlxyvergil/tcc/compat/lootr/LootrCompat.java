 ...
 * 因此所有直接引用 Lootr 类（{@link ILootrBlockEntity}、{@link ILootrSavedData}、{@link LootrAPI}）的方法，
...
public final class LootrCompat {
     ...
     *
     * <p>只有当前相（{@link ILootrSavedData}）存在、且该玩家还没有生成过独立库存
     * （{@link ILootrSavedData#getInventory(java.util.UUID)} 为空）时才返回 {@code true}。</p>
     */
