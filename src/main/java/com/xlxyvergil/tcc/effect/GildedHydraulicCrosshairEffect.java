...
public class GildedHydraulicCrosshairEffect extends MobEffect {
    public GildedHydraulicCrosshairEffect() {
        ...
        this.addAttributeModifier(AttributeHelper.CRIT_CHANCE,
            ResourceLocation.fromNamespaceAndPath(TaczCurios.MODID, "gilded_hydraulic_crosshair_effect_2a51f151_e7aa"), perLevelValue, AttributeModifier.Operation.ADD_MULTIPLIED_BASE);
